...
from .generator import generate_cloud_natural, generate_cloud_regular               # Import generation functions.
from .reduction import reduce_points_by_region                                      # Import reduction function.
from .visualization import create_visualization                                     # Import visualization creator.
...
def handle_reduce(args: argparse.Namespace):
    """
...
def main():
    ...
    parser_red.add_argument(                                                        # Add an argument to 'reduce'.
        ...
        help="Reduction multiplier. 1 = ~50% reduction. 2 = ~75% reduction (default). Higher = fewer points." # Help text for multiplier.
    )
