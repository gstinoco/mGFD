...
class BoundaryCondition:                                                                                                                # Base boundary condition class.
    ...
    Provides a standardized abstraction to represent constant, functional, or array-based values 
    evaluated precisely along the boundary nodes of a point cloud. Includes automated fallback 
    logic for vectorized callable evaluation and coordinate-based lookups via cKDTree.
    """
