...
class Cloud:                                                                                                                            # OOP Point Cloud class.
    ...
    @classmethod                                                                                                                        # Execute statement.
    def generate_natural(cls, csv_contour: str, output_csv: str = "generated_cloud.csv",                                                # Factory constructor via Natural Poisson Disk.
    ...
    @classmethod                                                                                                                        # Execute statement.
    def generate_regular(cls, csv_contour: str, output_csv: str = "generated_cloud.csv",                                                # Factory constructor via Regular Grid.
                        cloud_size: Optional[float] = None, density_multiplier: float = 1.0,                                            # Assign cloud_size: Optional[float].
